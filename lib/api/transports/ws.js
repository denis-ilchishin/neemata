        ...
        (connection, req) => {
          ...
          client.on('close', async () => {
            ...
            await this.application
              .executeHook('disconnection', {
                auth,
                client: client,
                req,
              })
              .catch((err) => this.connection.exception(err, 'App'))
          })
          ...
          client.on('message', async (message) => {
            try {
              ...
              this.application.console.error(err)
            }
          })
          ...
          const getReady = async () => {
            auth = client.auth = await this.handleAuth(this.resolveAuth(req))
