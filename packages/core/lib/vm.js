...
// // const { isNullish } = require('./utils/functions')
...
//     return esmodule.namespace.default
//   }
...
// const TYPING_HELPERS = ['defineProcedure', 'defineAuthService', 'defineGuard']
...
//   // Typing helpers
//   ...Object.fromEntries(
//     TYPING_HELPERS.map((name) => [name, ((value) => value).bind(undefined)])
//   ),
// })
